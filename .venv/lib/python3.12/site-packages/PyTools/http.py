...
class UriTool:
    ...
    def url_query_replace(url: str, key: str, val: str, encoding="utf-8") -> str:
        ...
        new_query = "&".join(
            map(
                lambda x: "{0}={1}".format(x, parse.quote(qs[x][0], encoding=encoding)),
                qs,
            )
        )
    ...
    @staticmethod
    def url_query_param(
        url: str, key: str, *, default_value: str = "", encoding="utf-8"
    ) -> str:
        """
        获取链接中某个参数的值
        """
...
if __name__ == "__main__":
    ...
    print(
        UriTool.url_query_param(
            "https://list.jd.com/list.html?cat=1620,13780", "page", default_value=0
        )
    )
    pass
